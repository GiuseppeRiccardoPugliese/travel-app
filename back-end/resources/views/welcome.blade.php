...
@section('content')
    ...
    <script>
        document.getElementById("search_city").addEventListener('input', function() {
            ...
            const url =
                `https://api.tomtom.com/search/2/search/${query}.json?key=JaJJHJ6GGLUhADXt9Iuu4C5oaRT5Ah96&typeahead=true&limit=5&entityTypeSet=Municipality`;
        ...
        function selectCity(city) {
            ...
            marker = new tt.Marker().setLngLat([city.position.lon, city.position.lat]).addTo(map);
        }
    </script>
@endsection
