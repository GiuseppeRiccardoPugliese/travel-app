<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            {{ __('Una volta che il tuo account è eliminato, tutte le risorse collegate saranno eliminate permanentemente. Prima di procedere per favore fai un backup dei dati importanti!') }}
        </p>
    </header>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="mt-1 text-sm text-gray-600">
                        {{ __('Una volta che il tuo account è eliminato, tutte le risorse collegate saranno eliminate permanentemente. Per favore inserisci la tua password per confermare.') }}
                    </p>
                </div>
