...
<div class="card">
    <div class="container">
        <form id="myForm" action="{{ route('trip.update', $trip->id) }}" method="POST" enctype="multipart/form-data"
    ...
    <div class="input-group mb-3">
        ...
        <input type="date" id="data_inizio" name="data_inizio" class="form-control" value="{{$trip->data_inizio}}">
    ...
    <div class="input-group mb-3">
        ...
        <input type="date" id="data_fine" name="data_fine" class="form-control"  value="{{$trip->data_fine}}">
    ...
    <div class="input-group mb-3">
        ...
        <input type="text" id="destinazione" name="destinazione" class="form-control"  value="{{$trip->destinazione}}">
